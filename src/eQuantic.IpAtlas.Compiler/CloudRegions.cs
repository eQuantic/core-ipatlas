...
public static class CloudRegions
{
    ...
    private static readonly Dictionary<string, CloudRegion> Table = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["mexicocentral"] = new("MX", "Queretaro", 20.59, -100.39),
        ["chilecentral"] = new("CL", "Santiago", -33.45, -70.67),
        ["denmarkeast"] = new("DK", "Copenhagen", 55.68, 12.57),
        ["belgiumcentral"] = new("BE", "Brussels", 50.85, 4.35),
        ["swedensouth"] = new("SE", "Malmo", 55.60, 13.00),
        ["taiwannorth"] = new("TW", "Taipei", 25.03, 121.57),
        ["taiwannorthwest"] = new("TW", "Taoyuan", 24.99, 121.30),
        ["malaysiasouth"] = new("MY", "Johor", 1.49, 103.74),
        ["israelnorthwest"] = new("IL", "Haifa", 32.79, 34.99),
        ["indiasouthcentral"] = new("IN", "Hyderabad", 17.39, 78.49),
        ["jioindiawest"] = new("IN", "Jamnagar", 22.47, 70.06),
        ["jioindiacentral"] = new("IN", "Nagpur", 21.15, 79.09),
        ["eastus3"] = new("US", "Atlanta", 33.75, -84.39),
        ["southeastus"] = new("US", "Atlanta", 33.75, -84.39),
        ["southeastus3"] = new("US", "Atlanta", 33.75, -84.39),
        ["southeastus5"] = new("US", "Atlanta", 33.75, -84.39),
        ["northeastus"] = new("US", "Ashburn", 39.04, -77.49),
        ["northeastus2"] = new("US", "Ashburn", 39.04, -77.49),
        ["northeastus5"] = new("US", "Ashburn", 39.04, -77.49),
        ["southwestus"] = new("US", "Phoenix", 33.45, -112.07),
        ["southwestus2"] = new("US", "Phoenix", 33.45, -112.07),
        ["southwestus3"] = new("US", "Phoenix", 33.45, -112.07),
        ["westus4"] = new("US", "Phoenix", 33.45, -112.07),

        // Azure ships short aliases for the same places alongside the canonical
        // names, and preview and staging regions that run in the region they are
        // named for. Unmapped, every one of them falls back to the country
        // Microsoft registered the address space in.
        ["centralfrance"] = new("FR", "Paris", 48.86, 2.35),
        ["southfrance"] = new("FR", "Marseille", 43.30, 5.37),
        ["germanywc"] = new("DE", "Frankfurt", 50.11, 8.68),
        ["germanyn"] = new("DE", "Berlin", 52.52, 13.40),
        ["switzerlandn"] = new("CH", "Zurich", 47.38, 8.54),
        ["switzerlandw"] = new("CH", "Geneva", 46.20, 6.14),
        ["norwaye"] = new("NO", "Oslo", 59.91, 10.75),
        ["norwayw"] = new("NO", "Stavanger", 58.97, 5.73),
        ["brazilse"] = new("BR", "Rio de Janeiro", -22.91, -43.17),
        ["chilec"] = new("CL", "Santiago", -33.45, -70.67),
        ["austriae"] = new("AT", "Vienna", 48.21, 16.37),
        ["polandc"] = new("PL", "Warsaw", 52.23, 21.01),
        ["spainc"] = new("ES", "Madrid", 40.42, -3.70),
        ["italyn"] = new("IT", "Milan", 45.46, 9.19),
        ["israelc"] = new("IL", "Tel Aviv", 32.09, 34.78),
        ["eastus2euap"] = new("US", "Ashburn", 39.04, -77.49),
        ["centraluseuap"] = new("US", "Des Moines", 41.59, -93.62),
        ["eastusstg"] = new("US", "Ashburn", 39.04, -77.49),
        ["southcentralusstg"] = new("US", "San Antonio", 29.42, -98.49),
        ["usstagee"] = new("US", "Ashburn", 39.04, -77.49),
        ["usstagec"] = new("US", "Des Moines", 41.59, -93.62),
        ["usstagew"] = new("US", "Quincy", 47.23, -119.85),
    };
}
