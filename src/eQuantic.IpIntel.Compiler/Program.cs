using eQuantic.IpIntel.Compiler;

// eqip build --rir <file>... [--asn <tsv>...] --out <path> [--source <text>]
if (args.Length == 0 || args[0] != "build")
{
    Console.Error.WriteLine("usage: eqip build --rir <delegated-extended-file>... [--asn <ip2asn-tsv>...] --out <dataset.eqip> [--source <text>]");
    return 1;
}
