...
/// <param name="Flags">What kind of network this is: hosting, anycast, anonymizer and so on.</param>
    ...
    IpLocation? Location = null)
{
    ...
    public bool IsLocatablePerson =>
        Scope == IpScope.Public && CountryCode is not null && (Flags & (IpFlags.Anycast | IpFlags.Anonymizer)) == 0;
}
